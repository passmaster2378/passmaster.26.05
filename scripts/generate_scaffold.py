...
PAGES = [
    ...
    },
    {
        ...
        "file": "enroll/opening-001/index.html",
        "title": "모집 상세",
        "section": "User",
        "summary": "선택한 과정의 모집 요강, 일정, 가격, 환불 조건을 검토합니다.",
        "back": "/enroll",
        "next": "/enroll/[openingId]/payment",
        "related": ["/terms", "/refund"],
    },
    {
        "route": "/enroll/[openingId]/payment",
        "file": "enroll/opening-001/payment/index.html",
        "title": "결제 진행",
        "section": "User",
        "summary": "결제 수단을 선택하고 최종 결제를 완료합니다.",
